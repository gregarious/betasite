...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('places_place', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Place.image_url'
        db.add_column('places_place', 'image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=400, blank=True), keep_default=False)
    ...
    models = {
        ...
        'places.favorite': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_favorite': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
