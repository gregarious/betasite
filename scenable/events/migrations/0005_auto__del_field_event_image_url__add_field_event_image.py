...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('events_event', 'image_url')

        # Adding field 'Event.image'
        db.add_column('events_event', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Event.image_url'
        db.add_column('events_event', 'image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=400, blank=True), keep_default=False)
