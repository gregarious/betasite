...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_event', (
            ...
            ('place_primitive', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ...
        db.create_table('events_eventmeta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('events', ['EventMeta'])
        ...
        db.create_table('events_icalendarfeed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=300)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Organization'], null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('events', ['ICalendarFeed'])

        # Adding M2M table for field candidate_places on 'ICalendarFeed'
        db.create_table('events_icalendarfeed_candidate_places', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('icalendarfeed', models.ForeignKey(orm['events.icalendarfeed'], null=False)),
            ('place', models.ForeignKey(orm['places.place'], null=False))
        ))
        db.create_unique('events_icalendarfeed_candidate_places', ['icalendarfeed_id', 'place_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('events_eventmeta')
        ...
        db.delete_table('events_icalendarfeed')

        # Removing M2M table for field candidate_places on 'ICalendarFeed'
        db.delete_table('events_icalendarfeed_candidate_places')
