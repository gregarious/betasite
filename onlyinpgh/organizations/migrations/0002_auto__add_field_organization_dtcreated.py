...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.dtcreated'
        db.add_column('organizations_organization', 'dtcreated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 3, 22, 17, 5, 9, 310995), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.dtcreated'
        db.delete_column('organizations_organization', 'dtcreated')
