...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Special.dtcreated'
        db.add_column('specials_special', 'dtcreated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 3, 22, 17, 6, 11, 240638), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Special.dtcreated'
        db.delete_column('specials_special', 'dtcreated')
