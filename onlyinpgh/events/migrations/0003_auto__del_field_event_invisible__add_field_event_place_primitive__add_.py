...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.invisible'
        db.delete_column('events_event', 'invisible')

        # Adding field 'Event.place_primitive'
        db.add_column('events_event', 'place_primitive', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Event.listed'
        db.add_column('events_event', 'listed', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Event.invisible'
        db.add_column('events_event', 'invisible', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Event.place_primitive'
        db.delete_column('events_event', 'place_primitive')

        # Deleting field 'Event.listed'
        db.delete_column('events_event', 'listed')
