...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_userprofile', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.display_name'
        db.alter_column('accounts_userprofile', 'display_name', self.gf('django.db.models.fields.TextField')(max_length=30))
