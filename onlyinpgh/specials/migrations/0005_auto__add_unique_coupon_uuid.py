...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Coupon', fields ['uuid']
        db.create_unique('specials_coupon', ['uuid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Coupon', fields ['uuid']
        db.delete_unique('specials_coupon', ['uuid'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 29, 18, 0, 34, 906317)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 29, 18, 0, 34, 906174)'}),
