...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Favorite.is_favorite'
        db.delete_column('places_favorite', 'is_favorite')

        # Deleting field 'Favorite.dtmodified'
        db.delete_column('places_favorite', 'dtmodified')


    def backwards(self, orm):
        
        # Adding field 'Favorite.is_favorite'
        db.add_column('places_favorite', 'is_favorite', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Favorite.dtmodified'
        db.add_column('places_favorite', 'dtmodified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 5, 1, 23, 27, 14, 204546), blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 23, 27, 14, 208553)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 23, 27, 14, 208321)'}),
