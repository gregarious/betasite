...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Organization.image_url'
        db.delete_column('organizations_organization', 'image_url')

        # Adding field 'Organization.image'
        db.add_column('organizations_organization', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Organization.image_url'
        db.add_column('organizations_organization', 'image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=400, blank=True), keep_default=False)
