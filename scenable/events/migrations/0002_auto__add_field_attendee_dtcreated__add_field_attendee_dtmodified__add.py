...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attendee.dtcreated'
        db.add_column('events_attendee', 'dtcreated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 3, 23, 14, 31, 48, 141301), blank=True), keep_default=False)

        # Adding field 'Attendee.dtmodified'
        db.add_column('events_attendee', 'dtmodified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 3, 23, 14, 32, 4, 156754), blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Attendee.dtcreated'
        db.delete_column('events_attendee', 'dtcreated')
