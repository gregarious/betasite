...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.dt_published'
        db.alter_column('news_article', 'dt_published', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'Article.dt_published'
        db.alter_column('news_article', 'dt_published', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'news.article': {
            ...
            'dt_published': ('django.db.models.fields.DateField', [], {}),
            'dtcreated': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fulltext_url': ('django.db.models.fields.URLField', [], {'max_length': '400'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_url': ('django.db.models.fields.URLField', [], {'max_length': '400'}),
            'related_events': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['events.Event']", 'symmetrical': 'False'}),
            'related_places': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['places.Place']", 'symmetrical': 'False'}),
