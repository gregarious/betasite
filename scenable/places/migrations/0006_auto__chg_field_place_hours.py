...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.hours'
        db.alter_column('places_place', 'hours', self.gf('scenable.places.models.HoursField')())

    def backwards(self, orm):

        # Changing field 'Place.hours'
        db.alter_column('places_place', 'hours', self.gf('django.db.models.fields.TextField')())
