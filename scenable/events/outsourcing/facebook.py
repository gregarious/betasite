...
from scenable.events.models import Event, EventMeta, Role
from scenable.places.outsourcing.facebook import FBPage, fbpage_to_place
from scenable.places import abbreviate_state
