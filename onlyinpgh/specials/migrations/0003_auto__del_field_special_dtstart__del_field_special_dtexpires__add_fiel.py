...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Special.dtstart'
        db.delete_column('specials_special', 'dtstart')

        # Deleting field 'Special.dtexpires'
        db.delete_column('specials_special', 'dtexpires')

        # Adding field 'Special.dexpires'
        db.add_column('specials_special', 'dexpires', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Special.dstart'
        db.add_column('specials_special', 'dstart', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Special.dtstart'
        db.add_column('specials_special', 'dtstart', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Special.dtexpires'
        db.add_column('specials_special', 'dtexpires', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Special.dexpires'
        db.delete_column('specials_special', 'dexpires')

        # Deleting field 'Special.dstart'
        db.delete_column('specials_special', 'dstart')
