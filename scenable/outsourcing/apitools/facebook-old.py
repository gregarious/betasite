from scenable.outsourcing.apitools import APIError, delayed_retry_on_ioerror
import urllib
import urllib2
import json
...
class GraphAPIClient(object):
    def __init__(self, access_token=None, default_timeout=None):
