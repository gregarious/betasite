...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "scenable.common.context_processors.site_domain",
    "scenable.common.context_processors.site_search_form",
    "scenable.common.context_processors.sidebar_feedback_form",
)
